...
use AlainSchlesser\Speaking\Metabox\Talk;

$event_display = empty( $this->event_link )
	? $this->event_name
	: "<a href=\"{$this->event_link}\">{$this->event_name}</a>";

$session_display = empty( $this->session_link )
	? $this->session_date
	: "<a href=\"{$this->session_link}\">{$this->session_date}</a>";

$video_display = empty( $this->video )
	? ''
	: "<a href=\"{$this->video}\">Link</a>";

$slides_display = empty( $this->slides )
	? ''
	: "<a href=\"{$this->slides}\">Link</a>";
...
<form class="talk-cpt-metabox">
	...
	<div class="talk-cpt-metabox-section talk-cpt-metabox-section-event"><?= __('Event:', 'as-speaking' ) ?> <span id="talk-cpt-event-display"><?= $event_display ?></span>
		...
		<div id="talk-cpt-event-fields" class="hide-if-js" style="display: none;">
			<input type="hidden" name="hidden_talk_cpt_event_name" id="hidden_talk_cpt_event_name" value="<?= $this->event_name ?>">
			<input type="hidden" name="hidden_talk_cpt_event_link" id="hidden_talk_cpt_event_link" value="<?= $this->event_link ?>">
			<label for="talk_cpt_event_name"><?= __('Set the name of the event:', 'as-speaking' ) ?></label>
			<input type="text" id="talk_cpt_event_name" name="talk_cpt_event_name" value="<?= $this->event_name ?>">
			<label for="talk_cpt_event_link"><?= __('Set the link the event should point to:', 'as-speaking' ) ?></label>
			<input type="text" id="talk_cpt_event_link" name="talk_cpt_event_link" value="<?= $this->event_link ?>">
	...
	<div class="talk-cpt-metabox-section talk-cpt-metabox-section-session"><?= __('Session:', 'as-speaking' ) ?> <span id="talk-cpt-session-display"><?= $session_display ?></span>
		...
		<div id="talk-cpt-session-fields" class="hide-if-js" style="display: none;">
			<input type="hidden" name="hidden_talk_cpt_session_date" id="hidden_talk_cpt_session_date" value="<?= $this->session_date ?>">
			<input type="hidden" name="hidden_talk_cpt_session_link" id="hidden_talk_cpt_session_link" value="<?= $this->session_link ?>">
			<label for="talk_cpt_session_date"><?= __('Set the date of the session:', 'as-speaking' ) ?></label>
			<input type="text" id="talk_cpt_session_date" name="talk_cpt_session_date" value="<?= $this->session_date ?>">
			<label for="talk_cpt_session_link"><?= __('Set the link the session should point to:', 'as-speaking' ) ?></label>
			<input type="text" id="talk_cpt_session_link" name="talk_cpt_session_link" value="<?= $this->session_link ?>">
	...
	<div class="talk-cpt-metabox-section talk-cpt-metabox-section-video"><?= __('Video:', 'as-speaking' ) ?> <span id="talk-cpt-video-display"><?= $video_display ?></span>
		...
		<div id="talk-cpt-video-input" class="hide-if-js" style="display: none;">
			<input type="hidden" name="hidden_talk_cpt_video" id="hidden_talk_cpt_video" value="<?= $this->video ?>">
			<label for="talk_cpt_video"><?= __('Set the link to the video recording:', 'as-speaking' ) ?></label>
			<input type="text" id="talk_cpt_video" name="talk_cpt_video" value="<?= $this->video ?>">
	...
	<div class="talk-cpt-metabox-section talk-cpt-metabox-section-slides"><?= __('Slides:', 'as-speaking' ) ?> <span id="talk-cpt-slides-display"><?= $slides_display ?></span>
		...
		<div id="talk-cpt-slides-input" class="hide-if-js" style="display: none;">
			<input type="hidden" name="hidden_talk_cpt_slides" id="hidden_talk_cpt_slides" value="<?= $this->slides ?>">
			<label for="talk_cpt_slides"><?= __('Set the link to the slides:', 'as-speaking' ) ?></label>
			<input type="text" id="talk_cpt_slides" name="talk_cpt_slides" value="<?= $this->slides ?>">
	...
	<div class="talk-cpt-metabox-section talk-cpt-metabox-section-featured-image"><?= __('Image links to:', 'as-speaking' ) ?> <span id="talk-cpt-image-link-display"><?= $image_link_captions[ $this->image_link ] ?></span>
		...
		<div id="talk-cpt-image-link-select" class="hide-if-js" style="display: none;">
			<input type="hidden" name="hidden_talk_cpt_image_link" id="hidden_talk_cpt_image_link" value="<?= $this->image_link ?>">
			...
			<select name="talk_cpt_image_link" id="talk_cpt_image_link">
				<?php foreach( $image_link_captions as $value => $caption ) : ?>
					<option <?php selected( $this->image_link, $value ); ?> value="<?= $value ?>"><?= $caption ?></option>
				<?php endforeach; ?>
			</select>
